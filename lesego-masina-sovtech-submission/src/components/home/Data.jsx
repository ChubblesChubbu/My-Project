...
export const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Lesego Masina
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        I’m a passionate software developer, born and raised in Johannesburg.
        I ‘am interested in joining the SovTech Software Development Stream 
        because I would love to assist and learn from everyone 
        within the programme. Being a part of a field where it challenges
        creativity, ideas and changing day-to-day tasks is 
